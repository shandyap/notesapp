...
class NotesApp extends React.Component{
    ...
    render() {
        return (
            ...
            <h2>Catatan Aktif</h2>
            <NotesAppList notes={this.state.notes.filter(note => note.archived === false)}/>
            <h2>Arsip</h2>
            <NotesArchivedList archivedNotes={this.state.archivedNotes} onDelete={this.onDeleteHandler} onMove={this.onMoveHandler} />
            </div>
            </>
        )
    }
